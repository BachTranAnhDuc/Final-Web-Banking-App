...
router.route('/transfer').post(authenticateUser, authorizePermissions(['user']),transferProcess);
...
//withdraw money
router.route("/withdraw").post(authenticateUser, authorizePermissions(['user']),validateWithdrawCard,withdrawMoney)
