...
const RegisterStyled = styled.main`
  ...
  .register__container-image {
  }

  /* SECTION REGISTER VERIFY */

  .section-register__verify {
    height: 100vh;
  ...
  .section-register__verify-image img {
    height: 50rem;
  }

  .section-register__verify-content {
    padding-top: 4.8rem;
    justify-self: start;
  ...
  .register__result--heading {
    /* background-color: var(--color-primary-light-3); */
  }

  .register__result--text {
